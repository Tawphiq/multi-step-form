...
const YearlyPlan = () => {
  return (
    <div>
      <div className='text-2xl mt-10 ml-10 text-blue-800 font-bold'>
        Select Your Plan
      </div>
      <div className='text-sm text-gray-400 ml-10'>You have the option of monthly or yearly bill</div>
      <div className='p-10 grid grid-cols-1 sm:grid-cols-3
       md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5'>
        
        <button className='border rounded-md p-2 hover:border-blue-800 hover:bg-gray-100'>
        ...
        <div className='mt-5 text-xs text-blue-800 font-semibold'>Advanced</div>
        ...
        <div className='text-sm text-gray-400'>$15/mo</div>
          ...
          <Box className='bg-gray-100 grid grid-cols-1  w-64 max-h-7'>
          <div className='grid grid-cols-2'>
          <button className='text-gray-400 font-semibold text-sm hover:text-gray-500'>Monthly</button> 
          <button className='text-blue-800 font-semibold text-sm hover:text-blue-600'>Yearly</button>
          </div>
          </Box>
        

        <div className='mt-20 grid grid-cols-2 w-64 -ml-20'>
