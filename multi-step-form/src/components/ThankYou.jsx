...
const ThankYou = () => {
  return (
    <div>
        ...
        <div className='flex mt-4 justify-center text-xl text-blue-800 font-bold'>Thank You!</div>
        <div className='text-xs text-gray-400 ml-10 mr-10 w-64 mt-1'>
            Thanks for confirming your subscription! We hope you  have
            fun using our platform. If you ever need supoport, feel 
            free to email us at mohammedtawfiqiddrisu5@gmail.com
        </div>
        </div>
    </div>
  )
